...
const signupUser = async (req, res) => {
	try {
		...
		console.log("New user data:", { name, email, username, password }); // Log new user data
...
const loginUser = async (req, res) => {
	try {
		...
		console.log("Attempting to find user with username or email:", username); // Log the username/email being searched
		...
		// Optional: check if account is frozen
		if (user.isFrozen) {
